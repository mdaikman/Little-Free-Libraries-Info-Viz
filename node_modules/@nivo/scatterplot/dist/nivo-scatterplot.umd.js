(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/colors'), require('@nivo/scales'), require('@nivo/annotations'), require('lodash/get'), require('lodash/isString'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('d3-scale'), require('@react-spring/web'), require('react/jsx-runtime'), require('@nivo/tooltip'), require('@nivo/voronoi')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', '@nivo/legends', '@nivo/colors', '@nivo/scales', '@nivo/annotations', 'lodash/get', 'lodash/isString', 'lodash/isNumber', 'lodash/isPlainObject', 'd3-scale', '@react-spring/web', 'react/jsx-runtime', '@nivo/tooltip', '@nivo/voronoi'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.nivo, global.nivo, global.nivo, global['lodash/get'], global['lodash/isString'], global['lodash/isNumber'], global['lodash/isPlainObject'], global.d3, global['@react-spring/web'], global['react/jsx-runtime'], global.nivo, global.nivo));
}(this, (function (exports, react, core, axes, legends, colors, scales, annotations, get, isString, isNumber, isPlainObject, d3Scale, web, jsxRuntime, tooltip, voronoi) { 'use strict';
